<?php 
	...
	function getSocial()
	{
		...
		$social = '';
		foreach($query->result_array() as $c):
			$social .= '<li><a href="'.$c['socialLink'].'" target="_blank" class="tooltips tooltipped '.$c['socialName'].'" data-position="top" data-delay="50" data-tooltip="'.$c['socialName'].'"> <i class="fa fa-'.$c['socialName'].'"></i></a></li>';
		endforeach;
		echo $social;
	}
