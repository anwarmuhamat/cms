...
class Hoosk_model extends CI_Model {
	...
	function updateSettings() {
		...
		if ($this->input->post('siteBackground') != ""){
			$data['siteBackground'] = $this->input->post('siteBackground');
		}
		if ($this->input->post('siteProfile') != ""){
			$data['siteProfile'] = $this->input->post('siteProfile');
		}
		if ($this->input->post('endpointUrl') != ""){
			$data['endpointUrl'] = $this->input->post('endpointUrl');
		}
		if ($this->input->post('endpointToken') != ""){
			$data['endpointToken'] = $this->input->post('endpointToken');
		}
		if ($this->input->post('userid') != ""){
			$data['userid'] = $this->input->post('userid');
		}
		if ($this->input->post('initiator') != ""){
			$data['initiator'] = $this->input->post('initiator');
		}
