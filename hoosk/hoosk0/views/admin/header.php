...
<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo BASE_URL;?>/admin"><img src="<?php echo ADMIN_THEME; ?>/images/image1.png" class="logo-icon" alt="Hoosk CMS"></a>
            </div>
            <!-- Top Menu Items -->
                ...
                <ul class="nav navbar-nav side-nav">
					...
					<li class="dropdown <?php if ($current == "pages") { echo "active"; } ?>">
                      ...
                      <ul id="pagesmenu" class="collapse<?php if ($current == "pages") { echo " in"; } ?>">
                        <li<?php if (($current == "pages")&&($this->uri->segment(3)=="")) { echo ' class="active"'; } ?>><a href="<?php echo BASE_URL; ?>/admin/pages"><?php echo $this->lang->line('nav_pages_all'); ?></a></li>
                        <li<?php if (($current == "pages")&&($this->uri->segment(3)=="new")) { echo ' class="active"'; } ?>><a href="<?php echo BASE_URL; ?>/admin/pages/new"><?php echo $this->lang->line('nav_pages_new'); ?></a></li>
                      </ul>
       				</li>
        ...
        <a href="javascript:;" data-toggle="collapse" data-target="#postsmenu"> <i class="fa fa-newspaper-o"></i> <span><?php echo $this->lang->line('nav_posts'); ?></span> <b class="caret"></b></a>
          <ul id="postsmenu" class="collapse<?php if ($current == "posts") { echo " in"; } ?>">
            <li<?php if (($current == "posts")&&($this->uri->segment(3)=="")) { echo ' class="active"'; } ?>><a href="<?php echo BASE_URL; ?>/admin/posts"><?php echo $this->lang->line('nav_posts_all'); ?></a></li>
            <li<?php if (($current == "posts")&&($this->uri->segment(3)=="new")) { echo ' class="active"'; } ?>><a href="<?php echo BASE_URL; ?>/admin/posts/new"><?php echo $this->lang->line('nav_posts_new'); ?></a></li>
            <li<?php if (($current == "posts")&&($this->uri->segment(3)=="categories")&&($this->uri->segment(4)=="")) { echo ' class="active"'; } ?>><a href="<?php echo BASE_URL; ?>/admin/posts/categories"><?php echo $this->lang->line('nav_categories_all'); ?></a></li>
            <li<?php if (($current == "posts")&&($this->uri->segment(3)=="categories")&&($this->uri->segment(4)=="new")) { echo ' class="active"'; } ?>><a href="<?php echo BASE_URL; ?>/admin/posts/categories/new"><?php echo $this->lang->line('nav_categories_new'); ?></a></li>
          </ul>
        </li>
        ...
        <a href="javascript:;" data-toggle="collapse" data-target="#usersmenu"> <i class="fa fa-user"></i> <span><?php echo $this->lang->line('nav_users'); ?></span> <b class="caret"></b></a>
          <ul id="usersmenu" class="collapse<?php if ($current == "users") { echo " in"; } ?>">
            <li<?php if (($current == "users")&&($this->uri->segment(3)=="")) { echo ' class="active"'; } ?>><a href="<?php echo BASE_URL; ?>/admin/users"><?php echo $this->lang->line('nav_users_all'); ?></a></li>
            <li<?php if (($current == "users")&&($this->uri->segment(3)=="new")) { echo ' class="active"'; } ?>><a href="<?php echo BASE_URL; ?>/admin/users/new"><?php echo $this->lang->line('nav_users_new'); ?></a></li>
          </ul>
        </li>
        ...
        <a href="javascript:;" data-toggle="collapse" data-target="#navigationmenu"> <i class="fa fa-list-alt"></i> <span><?php echo $this->lang->line('nav_navigation'); ?></span> <b class="caret"></b></a>
          <ul id="navigationmenu" class="collapse<?php if ($current == "navigation") { echo " in"; } ?>">
            <li <?php if (($current == "navigation")&&($this->uri->segment(3)=="")) { echo ' class="active"'; } ?>><a href="<?php echo BASE_URL; ?>/admin/navigation"><?php echo $this->lang->line('nav_navigation_all'); ?></a></li>
            <li<?php if (($current == "navigation")&&($this->uri->segment(3)=="new")) { echo ' class="active"'; } ?>><a href="<?php echo BASE_URL; ?>/admin/navigation/new"><?php echo $this->lang->line('nav_navigation_new'); ?></a></li>
          </ul>
        </li>
