...
class Admin extends CI_Controller {
	...
	public function updateSettings()
	{
		...
		if ($this->input->post('siteBackground') != ""){
			rename($path_upload . $this->input->post('siteBackground'), $path_images . $this->input->post('siteBackground'));
		}
		if ($this->input->post('siteProfile') != ""){
			rename($path_upload . $this->input->post('siteProfile'), $path_images . $this->input->post('siteProfile'));
		}
